  ...
  return (
    <div className="app__meetups__blog section__padding">
      <div className="app__updates__blog-heading">
        <h2
          className="text-white text-3xl font-semibold text-center pb-3"
          id="shegang"
        >
          SheGang Meetups
        </h2>
      ...
      <div className="app__meetups__blog-container">
        <div className="app__meetups__blog-container_groupA">
          ...
          &nbsp;
          <div className="app__meetups__blog-container_article bg-black-gradient-2 ">
            ...
            <div className="app__meetups__blog-container_article-content ">
              ...
              <ul>
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <li className="text-white text-xl">BOMM Tour Schedule</li>
                </a>
                <br />
                <a
                  ...
                  rel="noopener noreferrer"
                >
                  <li className="text-white text-xl">World Tour w/ Coldplay</li>
                </a>
              </ul>
            </div>
          </div>
