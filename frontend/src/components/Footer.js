  ...
  return (
    <div className='wrapper'>
        ...
        <a className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2" href="https://www.youtube.com/channel/UCFwC3Ryue6CorFm2xCEG0Aw" target="_blank" rel="noreferrer" title="youtube">
          ...
          <div className='app__social'>
          <a className='bg-transparent' href="https://www.linkedin.com/in/aaliyah-symlar-931213102/"  target="_blank" rel="noreferrer"><BsLinkedin /></a>
              &nbsp;
              <a className='bg-transparent' href="https://www.instagram.com/aaliyahsymlar/" target="_blank" rel="noreferrer">
                <BsInstagram />
              </a>
          </div>
    </footer>
